...
public class CrimeFragment extends Fragment {
    //static string to be used as the key for parametiers we set
    ...
    //of a CrimeFragment with the  correct infromation of a Crime
    //based on a UUID that is passed in. Any Activity including
    //the one we are using (Crime Activity) can call this method
    //and get a properly created CrimeFragmen. The method takes the
    //UUID that is passed in, and then sets it in an arguement bundle
    //that can be passsed along with the Fragment. Once the fragment
    //is started, te data in the bundle can be retrieved and used.
    public static CrimeFragment newInstance(UUID crimeId){
        //Create a new arguemments bundle
        ...
        //Set the arguements on the fragment with the bundle
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //by he Bundle called saveInstanceState, we need to fetch
        ...
        //base on the UUID that we have. In order to do that, we
        //get the (singleton) instance of our crime lab by calling
        //the static method 'get' on CrimeLab.  Now that we have crime lab,
        //we can call the getCrime method on it passing in the UUID to get back
        //a single crime.
